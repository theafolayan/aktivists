		...
		<div class="sixteen columns">
			<div class="search-container">
				...
				<div class="browse-jobs">
					Browse job offers by <a href="index.html"> category</a> or <a href="#">location</a>
				</div>
				<!-- Announce -->
<!-- 				<div class="announce">
	...
	<div class="sixteen columns">
		<h3 class="margin-bottom-20 margin-top-10">Popular Categories</h3>
			...
			<div class="categories-boxes-container">
				<!-- Box -->
				<a href="index.html" class="category-small-box">
		...
		<a href="index.html" class="button centered">Browse All Categories</a>
...
<div class="container">
	...
	<div class="padding-right">
		...
		<div class="listings-container">
			...
			<!-- Listing -->
			<a href="themes/workscout_2019/job-page.html" class="listing internship">
				<div class="listing-logo">
					<img src="themes/workscout_2019/images/job-list-logo-04.png" alt="">
				</div>
				<div class="listing-title">
			...
			<!-- Listing -->
			<a href="themes/workscout_2019/job-page.html" class="listing freelance">
				<div class="listing-logo">
					<img src="themes/workscout_2019/images/job-list-logo-05.png" alt="">
				</div>
				<div class="listing-title">
		...
		<a href="index.html" class="button centered"><i class="fa fa-plus-circle"></i> Show More Jobs</a>
		<div class="margin-bottom-55"></div>
	</div>
	</div>
	<!-- Job Spotlight -->
					...
					<ul>
						<li>
							<div class="job-spotlight">
								...
								<a href="themes/workscout_2019/job-page.html" class="button">Apply For This Job</a>
							</div>
						</li>
						<li>
							<div class="job-spotlight">
		...
		<div class="testimonial-carousel testimonials">
			...
			<div class="fw-carousel-review">
				...
				<div class="testimonial-author">
					<img src="themes/workscout_2019/images/resumes-list-avatar-03.png" alt="">
			...
			<div class="fw-carousel-review">
				...
				<div class="testimonial-author">
					<img src="themes/workscout_2019/images/resumes-list-avatar-02.png" alt="">
			...
			<div class="fw-carousel-review">
				...
				<div class="testimonial-author">
					<img src="themes/workscout_2019/images/resumes-list-avatar-01.png" alt="">
...
<!-- Flip banner -->
<a href="index.html" class="flip-banner margin-bottom-55" data-background="images/all-categories-photo.jpg" data-color="#26ae61" data-color-opacity="0.93">
...
<div class="container">
	...
	<div class="one-third column">
		...
		<div class="recent-post">
			<div class="recent-post-img"><a href="index.html"><img src="themes/workscout_2019/images/recent-post-01.jpg" alt=""></a><div class="hover-icon"></div></div>
			<a href="index.html"><h4>Hey Job Seeker, It’s Time To Get Up And Get Hired</h4></a>
			<div class="meta-tags">
			...
			<a href="index.html" class="button">Read More</a>
		</div>
	</div>
	<div class="one-third column">
		<!-- Post #2 -->
		<div class="recent-post">
			<div class="recent-post-img"><a href="index.html"><img src="themes/workscout_2019/images/recent-post-02.jpg" alt=""></a><div class="hover-icon"></div></div>
			<a href="index.html"><h4>How to "Woo" a Recruiter and Land Your Dream Job</h4></a>
			<div class="meta-tags">
	...
	<div class="one-third column">
		<!-- Post #3 -->
		<div class="recent-post">
			<div class="recent-post-img"><a href="index.html"><img src="themes/workscout_2019/images/recent-post-03.jpg" alt=""></a><div class="hover-icon"></div></div>
			<a href="index.html"><h4>11 Tips to Help You Get New Clients Through Cold Calling</h4></a>
			<div class="meta-tags">
