	...
	<div class="padding-right">
        ...
        <a href="{{route('opportunities.show',$opportunity->slug)}}" class="listing full-time">
				...
				<div class="listing-title">
					<h4>{{ $opportunity->title }} <span class="listing-type">{{ $opportunity->type }}</span></h4>
					<ul class="listing-icons">
						<li><i class="ln ln-icon-Management"></i> {{ $opportunity->category }}</li>
						<li><i class="ln ln-icon-Map2"></i> {{ $opportunity->location }}</li>
						{{-- <li><i class="ln ln-icon-Money-2"></i> $55 / hour</li> --}}
						<li><div class="listing-date">{{ $opportunity->deadline }}</div></li>
					</ul>
				</div>
			</a>
